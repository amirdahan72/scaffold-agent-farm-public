...
| Date       | Signal                                                                                              | Type           | Impact | Source                                                                  |
|:-----------|:----------------------------------------------------------------------------------------------------|:---------------|:-------|:------------------------------------------------------------------------|
| 2026-03-09 | Web & API Vulnerability Scanner (Open Beta) — AI-powered DAST for BOLA, auto-builds API call graphs | Product Launch  | High   | [source](https://blog.cloudflare.com/vulnerability-scanner/)            |
...
- **Akamai's integrated API+WAF enforcement** cited by customers as expectation for inline API security at the WAF/gateway layer — a gap Azure WAF is closing. *(Work IQ — Feb 23 WAF & API Security meeting)*
...
- [ ] **GCP Cloud Armor + Gemini** — monitor whether Google integrates Gemini AI into Cloud Armor detection *(GCP not a tracked competitor in this digest but signal remains relevant to Azure WAF positioning)* — first flagged: 2026-03-09
...
*Generated on March 10, 2026 by the Weekly Competitive Digest Agent Farm.*  
